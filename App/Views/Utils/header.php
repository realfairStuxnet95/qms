    ...
    <div class="mdk-header__content">
        ...
        <nav class="navbar navbar-expand-md bg-primary navbar-dark d-flex-none">
            ...
            <div class="page-title m-0">
                <?php 
                 if(isset($_GET['training_name'])){
                    echo $_GET['training_name'];
                 }else{
                    echo "QMS System";
                 }
                ?>
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">
                                            <div class="media align-items-center">
                                                <i class="material-icons align-middle mr-2 text-warning">info_outline</i>
                                        ...
                                        <li class="list-group-item">
                                            <div class="media align-items-center">
                                                <i class="material-icons align-middle mr-2 text-success">check_circle</i>
                                                <div class="media-body">
                                                    <div class="w-100">
                                        ...
                                        <li class="list-group-item">
                                            <div class="media align-items-center">
                                                <i class="material-icons align-middle mr-2 text-danger">warning</i>
                                                <div class="media-body">
                                                    <div class="w-100">
                    ...
                    <li class="nav-item nav-divider">
                        <li class="nav-item">
                            <a href="#" class="nav-link dropdown-toggle dropdown-clear-caret" data-toggle="sidebar" data-target="#user-drawer">
                                ...
                                <img src="assets/images/avatars/avatar.png" class="img-fluid rounded-circle ml-1" width="35" alt="">
                            </a>
                        </li>
                </ul>
            </div>
